...
public class SlimeTNTEntity extends AbstractTNTEntity {
    ...
    public SlimeTNTEntity(EntityType<? extends SlimeTNTEntity> type, Level worldIn) {

        super(type, worldIn);
    }

    public SlimeTNTEntity(Level worldIn, double x, double y, double z, @Nullable LivingEntity igniter) {
