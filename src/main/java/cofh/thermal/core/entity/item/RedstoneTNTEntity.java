...
public class RedstoneTNTEntity extends AbstractTNTEntity {
    ...
    public RedstoneTNTEntity(EntityType<? extends RedstoneTNTEntity> type, Level worldIn) {

        super(type, worldIn);
    }

    public RedstoneTNTEntity(Level worldIn, double x, double y, double z, @Nullable LivingEntity igniter) {
