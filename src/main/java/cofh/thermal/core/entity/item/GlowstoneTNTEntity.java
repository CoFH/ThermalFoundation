...
public class GlowstoneTNTEntity extends AbstractTNTEntity {
    ...
    public GlowstoneTNTEntity(EntityType<? extends GlowstoneTNTEntity> type, Level worldIn) {

        super(type, worldIn);
    }

    public GlowstoneTNTEntity(Level worldIn, double x, double y, double z, @Nullable LivingEntity igniter) {
