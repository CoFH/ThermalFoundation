...
public class BasalzProjectileRenderer extends EntityRenderer<BasalzProjectileEntity> {
    ...
    @Override
    public void render(BasalzProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack poseStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(BasalzProjectileEntity entity) {
