...
public class TCoreTileEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>> DEVICE_XP_CONDENSER_TILE = null;
    public static final RegistryObject<BlockEntityType<?>> DEVICE_HEAT_EXCHANGER_TILE = null;
