...
public class TCoreBlocks {
    ...
    private static void registerTileBlocks() {
        ...
        // registerAugmentableBlock(ID_DEVICE_MAGNET_BLOCKER, () -> new TileBlockActive4Way(of(Material.METAL).sound(SoundType.LANTERN).strength(2.0F), DeviceCollectorTile.class, DEVICE_MAGNET_BLOCKER_TILE), deviceAugs, DeviceCollectorTile.AUG_VALIDATOR, getFlag(ID_DEVICE_MAGNET_BLOCKER));
