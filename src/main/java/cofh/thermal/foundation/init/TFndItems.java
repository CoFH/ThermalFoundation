...
import static cofh.thermal.lib.common.ThermalCreativeTabs.THERMAL_BLOCKS;
import static cofh.thermal.lib.common.ThermalCreativeTabs.THERMAL_ITEMS;
...
public class TFndItems {
    ...
    public static void register() {
        ...
        //
        //        registerItem(ID_RUBBERWOOD_BOAT, () -> new BoatItemCoFH(RUBBERWOOD_BOAT, BoatCoFH::new, new Item.Properties()).setModId(ID_THERMAL_FOUNDATION));
        //        registerItem(ID_RUBBERWOOD_CHEST_BOAT, () -> new BoatItemCoFH(RUBBERWOOD_CHEST_BOAT, ChestBoatCoFH::new, new Item.Properties()).setModId(ID_THERMAL_FOUNDATION));
        //        registerItem("rubberwood_sign", () -> new SignItemCoFH(new Item.Properties().stacksTo(16), BLOCKS.get("rubberwood_sign"), BLOCKS.get("rubberwood_wall_sign")).setModId(ID_THERMAL_FOUNDATION));
    }
