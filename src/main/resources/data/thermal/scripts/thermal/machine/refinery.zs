...
// <recipetype:thermal:refinery>.addRecipe(name as string, itemOutput as Percentaged<IItemStack>, fluidsOutput as IFluidStack[], inputFluid as CTFluidIngredient, energy as int);
